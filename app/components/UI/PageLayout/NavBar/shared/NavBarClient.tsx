...
export default function NavBarClient({
  ...
  return (
    <nav className="w-full max-w-7xl mx-auto flex items-center justify-between px-6 md:px-8">
      <Link
        href="/"
        prefetch
      ...
      >
        <Image
          ...
          priority
        />
        <span className="font-semibold text-lg bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">{APP_NAME}</span>
      </Link>
      ...
      <div className="flex items-center gap-4 sm:gap-5">
        ...
        <Link href={token ? "/profile" : "/auth"} prefetch className="flex items-center">
          <MyAccountIcon />
        </Link>
